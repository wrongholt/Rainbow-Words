...
module.exports = {
    ...
    // Beta Testing
    callGetBetaTest: callGetBetaTest,
    callCreateBetaTest: callCreateBetaTest,
    callUpdateBetaTest: callUpdateBetaTest,
    callStartBetaTest: callStartBetaTest,
    callEndBetaTest: callEndBetaTest,
    callListBetaTesters: callListBetaTesters,
    callAddBetaTesters: callAddBetaTesters,
    callRemoveBetaTesters: callRemoveBetaTesters,
    callSendReminderToBetaTesters: callSendReminderToBetaTesters,
    callRequestFeedbackFromBetaTesters: callRequestFeedbackFromBetaTesters
};
...
/**
 * Get the beta test of given Alexa skill
 * @param skillId [Required] skill id
 * @param profile user profile
 * @param doDebug CLI debug mode
 * @param callback callback function from command
 */
function callGetBetaTest(skillId, profile, doDebug, callback) {
    ...
    const headers = {};
    requestWrapper.request('get-beta-test', general, headers, null, profile, doDebug, callback);
}

/**
 * Create a beta test of given Alexa skill
 * @param skillId [Required] skill id
 * @param feedbackEmail email address for providing feedback
 * @param profile user profile
 * @param doDebug CLI debug mode
 * @param callback callback function from command
 */
function callCreateBetaTest(skillId, feedbackEmail, profile, doDebug, callback) {
    const url = '/skills/' + skillId + '/betaTest';
    const general = {
        url: url,
        method: 'POST'
    ...
    requestWrapper.request('create-beta-test', general, headers, payload, profile, doDebug, callback);
}

/**
 * Update the beta test of given Alexa skill
 * @param skillId [Required] skill id
 * @param feedbackEmail email address for providing feedback
 * @param profile user profile
 * @param doDebug CLI debug mode
 * @param callback callback function from command
 */
function callUpdateBetaTest(skillId, feedbackEmail, profile, doDebug, callback) {
    const url = '/skills/' + skillId + '/betaTest';
    const general = {
        url: url,
        method: 'PUT'
    ...
    requestWrapper.request('update-beta-test', general, headers, payload, profile, doDebug, callback);
}

/**
 * Start a beta test of given Alexa skill
 * @param skillId [Required] skill id
 * @param profile user profile
 * @param doDebug CLI debug mode
 * @param callback callback function from command
 */
function callStartBetaTest(skillId, profile, doDebug, callback) {
    ...
    const headers = {};
    requestWrapper.request('start-beta-test', general, headers, null, profile, doDebug, callback);
}

/**
 * End a beta test of given Alexa skill
 * @param skillId [Required] skill id
 * @param profile user profile
 * @param doDebug CLI debug mode
 * @param callback callback function from command
 */
function callEndBetaTest(skillId, profile, doDebug, callback) {
    ...
    const headers = {};
    requestWrapper.request('end-beta-test', general, headers, null, profile, doDebug, callback);
}
 ...
 * @param callback callback function from command
 */
function callListBetaTesters(skillId, nextToken, maxResults, profile, doDebug, callback) {
    const url = nextToken ?
        '/skills/' + skillId + '/betaTest/testers?nextToken=' + nextToken + '&maxResults=' + (maxResults || CONSTANTS.BETA_TEST.DEFAULT_LIST_MAX_RESULT) :
        '/skills/' + skillId + '/betaTest/testers?maxResults=' + (maxResults || CONSTANTS.BETA_TEST.DEFAULT_LIST_MAX_RESULT) ;
    const general = {
        url: url,
        method: 'GET'
    };
    const headers = {};
    requestWrapper.request('list-beta-testers', general, headers, null, profile, doDebug, callback);
}
 ...
 * @param callback callback function from command
 */
function callAddBetaTesters(skillId, testers, profile, doDebug, callback) {
    ...
    requestWrapper.request('add-beta-testers', general, headers, payload, profile, doDebug, callback);
}

/**
 * Remove testers from a beta test of given Alexa skill
 * @param skillId [Required] skill id
 * @param testers tester email id list
 * @param profile user profile
 * @param doDebug CLI debug mode
 * @param callback callback function from command
 */
function callRemoveBetaTesters(skillId, testers, profile, doDebug, callback) {
    ...
    requestWrapper.request('remove-beta-testers', general, headers, payload, profile, doDebug, callback);
}

/**
 * Send reminder to testers in a beta test of given Alexa skill
 * @param skillId [Required] skill id
 * @param testers tester email id list
 * @param profile user profile
 * @param doDebug CLI debug mode
 * @param callback callback function from command
 */
function callSendReminderToBetaTesters(skillId, testers, profile, doDebug, callback) {
    ...
    requestWrapper.request('send-reminder-to-beta-testers', general, headers, payload, profile, doDebug, callback);
}
 ...
 * @param callback callback function from command
 */
function callRequestFeedbackFromBetaTesters(skillId, testers, profile, doDebug, callback) {
    ...
    requestWrapper.request('request-feedback-from-beta-testers', general, headers, payload, profile, doDebug, callback);
}
