...
module.exports.uploadByName = (func, src, revisionId, awsProfile, callback) => {
    module.exports.createZip(src, (zipFilePath) => {
        uploadToLambda(func, zipFilePath, revisionId, awsProfile, callback);
    });
};
...
// Private
function uploadToLambda(functionName, zipFilePath, revisionId, awsProfile, callback) {
    ...
    lambdaClient.updateFunctionCode(params, (err, data) => {
