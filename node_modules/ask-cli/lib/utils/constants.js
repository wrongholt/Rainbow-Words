...
module.exports.DIFF = {
    ...
    ERROR_MESSAGE: {
        ...
        CWD_INVALID: `[Error]: Failed to diff. Please ensure current working directory is the root of your skill project that contains the project config in the hidden .ask folder.`,
...
module.exports.SMAPI = {
    ENDPOINT: 'https://api-amazonalexa.integ.amazon.com',
    VERSION: {
        V0: 'v0',
        V1: 'v1'
    }
...
module.exports.LWA = {
    ...
    DEFAULT_SCOPES : SCOPES_SKILLS_READWRITE + ' ' + SCOPES_MODELS_READWRITE + ' ' + SCOPES_SKILLS_TEST,
...
module.exports.COMMAND = {
    ...
    NAME: {
        ...
        // Account Linking
        CREATE_ACCOUNT_LINKING: 'create-account-linking',
...
const MAX_LIST_MAX_RESULT = 500;

module.exports.BETA_TEST = {
    DEFAULT_LIST_MAX_RESULT: DEFAULT_LIST_MAX_RESULT,
    MAX_LIST_MAX_RESULT: MAX_LIST_MAX_RESULT
};
