...
module.exports = {
    ...
    isLambdaUsingAskSdk: isLambdaUsingAskSdk
};
...
function isLambdaUsingAskSdk(sourceDir) {
    const packagePath = path.join(sourceDir, 'package.json');
    if (fs.existsSync(packagePath)) {
        const packageInfo = jsonUtility.read(packagePath);
        if (jsonUtility.getPropertyValueFromObject(packageInfo, ['dependencies', 'ask-sdk-core']) &&
            jsonUtility.getPropertyValueFromObject(packageInfo, ['dependencies', 'ask-sdk-model'])) {
            return true;
        }
    }
    return false;
